...
namespace K19.Controllers
{
    public class LivroController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LivroID,Titulo,Preco,EditoraID")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LivroID,Titulo,Preco,EditoraID")] Livro livro)
        {
            if (ModelState.IsValid)
            {
